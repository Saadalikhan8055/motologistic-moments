...
const packages = [
  {
    ...
    features: [
      'Coordinated delivery to preferred location',
      'Premium black satin cloth reveal',
      'White-glove vehicle handling',
      'High-quality cinematic reel',
      'Basic photo coverage (5–7 images)',
      'Key handover presentation',
    ],
    icon: '✨',
    highlight: false,
  },
  {
    ...
    price: '₹19,999',
    description: 'A curated and personalized experience with better control, styling, and documentation',
    features: [
      'Everything in Essential Reveal',
      'Guided reveal flow with PDI',
      'Outfit suggestions included',
      'One premium printed photo frame',
      'Enhanced photo set (8–12 images)',
      'Improved cinematic reel',
    ],
    icon: '🎬',
    highlight: true,
  },
  {
    ...
    name: 'Luxury Reveal',
    price: '₹29,999',
    description: 'A refined, cinematic, and premium execution focused on visual impact and experience quality',
    features: [
      'Everything in Signature Reveal',
      'Enhanced reveal choreography',
      'Portable lighting setup',
      'Extended cinematic video (45–60s)',
      'Premium photo set (15–20 images)',
      'VIP-style entry coordination',
    ],
    icon: '👑',
    highlight: false,
  },
