  ...
  const packages: Package[] = [
    {
      ...
      price: '₹15,999',
      description: 'Professional vehicle delivery with standard presentation',
      features: [
    ...
    },
    {
      ...
      price: '₹34,999',
      description: 'Premium cinematic experience with full multimedia coverage',
      features: [
    ...
    },
    {
      ...
      price: '₹59,999',
      description: 'Bespoke luxury experience with exclusive amenities and white-glove service',
      features: [
        '✓ 8K Cinematic Video',
        '✓ Professional Photoshoot',
        '✓ Drone Footage',
